...
#include "Starbreeze/Public/SkelMeshMergeSectionMapping_BP.h"
#ifdef _MSC_VER
#pragma warning (push)
...
class UScriptStruct* FSkelMeshMergeSectionMapping_BP::StaticStruct()
{
	...
	if (!Singleton)
	{
		extern STARBREEZE_API uint32 Get_Z_Construct_UScriptStruct_FSkelMeshMergeSectionMapping_BP_Hash();
		Singleton = GetStaticStruct(Z_Construct_UScriptStruct_FSkelMeshMergeSectionMapping_BP, Z_Construct_UPackage__Script_Starbreeze(), TEXT("SkelMeshMergeSectionMapping_BP"), sizeof(FSkelMeshMergeSectionMapping_BP), Get_Z_Construct_UScriptStruct_FSkelMeshMergeSectionMapping_BP_Hash());
	}
	return Singleton;
}
template<> STARBREEZE_API UScriptStruct* StaticStruct<FSkelMeshMergeSectionMapping_BP>()
{
	return FSkelMeshMergeSectionMapping_BP::StaticStruct();
}
static FCompiledInDeferStruct Z_CompiledInDeferStruct_UScriptStruct_FSkelMeshMergeSectionMapping_BP(FSkelMeshMergeSectionMapping_BP::StaticStruct, TEXT("/Script/Starbreeze"), TEXT("SkelMeshMergeSectionMapping_BP"), false, nullptr, nullptr);
static struct FScriptStruct_Starbreeze_StaticRegisterNativesFSkelMeshMergeSectionMapping_BP
{
	FScriptStruct_Starbreeze_StaticRegisterNativesFSkelMeshMergeSectionMapping_BP()
	{
		UScriptStruct::DeferCppStructOps<FSkelMeshMergeSectionMapping_BP>(FName(TEXT("SkelMeshMergeSectionMapping_BP")));
	}
} ScriptStruct_Starbreeze_StaticRegisterNativesFSkelMeshMergeSectionMapping_BP;
	...
	uint32 Get_Z_Construct_UScriptStruct_FSkelMeshMergeSectionMapping_BP_Hash() { return 508261200U; }
