...
void EmptyLinkFunctionForGeneratedCodeGridly_init() {}
	...
	UPackage* Z_Construct_UPackage__Script_Gridly()
	{
		...
		if (!ReturnPackage)
		{
			static UObject* (*const SingletonFuncArray[])() = {
				(UObject* (*)())Z_Construct_UDelegateFunction_Gridly_DownloadGridlyNativeCultureDelegate__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_Gridly_DownloadLocalizedTextsDelegate__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_Gridly_ImportDataTableFromGridlyDelegate__DelegateSignature,
			};
